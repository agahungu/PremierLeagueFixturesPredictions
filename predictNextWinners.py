...
with open("Fixtures2325.csv", "r") as csvfile:
    ...
    for nextFixture in nextFixtures:
        if (
            nextFixture[11] == ""
            and nextFixture[3] != "Leicester"
            and nextFixture[3] != "Ipswich"
            and nextFixture[3] != "Southampton"
            and nextFixture[4] != "Leicester"
            and nextFixture[4] != "Ipswich"
            and nextFixture[4] != "Southampton"
        ):
            ####### MAIN FUNCTION #######
